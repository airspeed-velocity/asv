...
def test_repo_hg(tmpdir):
    ...
    def test_it(is_remote=False):
        ...
        branch_commits = {
            ...
            'somebranch': [dvcs.get_hash('somebranch'),
                           dvcs.get_hash('somebranch~6')]
        }
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [], [
                "Revision 6", "Revision 4", "Merge stable", "Revision 3", "Revision 1",
                "Revision 5", "Merge master", "Revision 2"
            ]
        ),
