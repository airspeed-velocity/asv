...
try:
    ...
    raise ImportError(
        "sphinx_bootstrap_theme must be installed to build the docs.  Try `pip install sphinx_bootstrap_theme`.")
...
latex_documents = [
  ('index', 'airspeedvelocity.tex', u'airspeed velocity Documentation',
...
man_pages = [
    ('index', 'airspeedvelocity', u'airspeed velocity Documentation',
...
texinfo_documents = [
  ('index', 'airspeedvelocity', u'airspeed velocity Documentation',
   u'Michael Droettboom', 'airspeedvelocity', 'One line description of project.',
   'Miscellaneous'),
]
